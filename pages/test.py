...
# @callback(Output('test-field-graph', 'figure'), Input('demo-dropdown', 'value'), Input('test-table', 'active_cell'), prevent_initial_call=True, allow_duplicates=True, suppress_callback_exceptions=True)
